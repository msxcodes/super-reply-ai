    ...
    return (
        <>
            <section className="bg-black text-white">
                <SectionContainer className="px-10 py-10 md:px-0 md:py-10">
                    <div className="flex flex-wrap items-center justify-between gap-10 md:flex-row md:items-start md:justify-between md:pb-10 md:pt-10">
                        <div className="flex w-full items-center justify-between pt-4 md:w-auto md:pt-0">
                            ...
                            <div className="inline-item flex items-center justify-center gap-5 md:hidden">
                    ...
                    <div className="mb-10 mt-20 flex flex-col items-center justify-between gap-5 font-space-grotesk md:mb-0 md:flex-row">
